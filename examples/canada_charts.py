...
def simple_payload_category_per_year():
    ...
    os.makedirs(f'examples/outputs/raw_dataframes/canada', exist_ok=True)
    dataset.satcat.df.to_csv(f'examples/outputs/raw_dataframes/canada/{output_name}.csv', index=False)
    ...
    os.makedirs(f'examples/outputs/csv/canada', exist_ok=True)
    output_df.to_csv(f"examples/outputs/csv/canada/{output_name}.csv", index=True)
    print(f"CSV file '{output_name}.csv' has been created.")

    os.makedirs(f'examples/outputs/chart/canada', exist_ok=True)
