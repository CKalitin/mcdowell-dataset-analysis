...
def main(start_year, end_year):
    dateset_name = f"f9_launch_vs_month_by_orbit_{start_year}_{end_year}"
    ...
    general_launch_payload_Types = ['LEO', 'SSO', 'MEO', 'GTO', 'GEO', 'HEO', 'BEO']
    ...
    mda.ChartUtils.plot_bar(
        output_df,
        title='F9 Launches vs. Month by Orbit',
